...
const Featured = () => {
  ...
  return (
    <div className='max-w-[1520px] h-[500px] w-full py-4 px-4 relative group'>
      ...
      <div className="hidden group-hover:block absolute top-[50%] -translate-x-0 translate-y-[50%] left-5 text-2xl rounded-full p-2 bg-orange-800 text-white">
        <BsChevronCompactLeft size={25} onClick={prevSlider}/>
      </div>
      <div className="hidden group-hover:block absolute top-[50%] -translate-x-0 translate-y-[50%] right-5 text-2xl rounded-full p-2 bg-orange-800 text-white">
